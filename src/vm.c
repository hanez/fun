...
void vm_run(VM *vm, Bytecode *entry) {
    ...
    while (vm->fp >= 0) {
        ...
        switch (inst.op) {
            ...
            #include "vm_case_nop.c"
            #include "vm_case_load_const.c"
            #include "vm_case_load_local.c"
            #include "vm_case_store_local.c"
            #include "vm_case_add.c"
            #include "vm_case_sub.c"
            #include "vm_case_mul.c"
            #include "vm_case_div.c"
            #include "vm_case_lt.c"
            #include "vm_case_lte.c"
            #include "vm_case_jump.c"
            #include "vm_case_gt.c"
            #include "vm_case_gte.c"
            #include "vm_case_eq.c"
            #include "vm_case_neq.c"
            #include "vm_case_jump_if_false.c"
            #include "vm_case_call.c"
            #include "vm_case_return.c"
            #include "vm_case_print.c"
            #include "vm_case_halt.c"
