...
void vm_run(VM *vm, Bytecode *entry) {
    ...
    while (vm->fp >= 0) {
        ...
        switch (inst.op) {
            ...
            #include "vm_cases/core/vm_case_nop.c"
            #include "vm_cases/core/vm_case_load_const.c"
            #include "vm_cases/core/vm_case_load_local.c"
            #include "vm_cases/core/vm_case_store_local.c"
            #include "vm_cases/arithmetic/vm_case_add.c"
            #include "vm_cases/arithmetic/vm_case_sub.c"
            #include "vm_case_mul.c"
            #include "vm_case_div.c"
            #include "vm_case_lt.c"
            #include "vm_case_lte.c"
            #include "vm_cases/core/vm_case_jump.c"
            #include "vm_case_gt.c"
            #include "vm_case_gte.c"
            #include "vm_cases/logic/vm_case_eq.c"
            #include "vm_case_neq.c"
            #include "vm_cases/core/vm_case_jump_if_false.c"
            #include "vm_case_call.c"
            #include "vm_case_return.c"
            #include "vm_case_print.c"
            #include "vm_cases/core/vm_case_halt.c"
            #include "vm_case_pop.c"
            #include "vm_case_dup.c"
            #include "vm_case_swap.c"
            #include "vm_case_make_array.c"
            #include "vm_case_index_get.c"
            #include "vm_case_index_set.c"
            #include "vm_case_len.c"
            #include "vm_case_arr_push.c"
            #include "vm_case_arr_pop.c"
            #include "vm_case_arr_set.c"
            #include "vm_case_arr_insert.c"
            #include "vm_case_arr_remove.c"
            #include "vm_case_slice.c"
            #include "vm_case_to_number.c"
            #include "vm_case_to_string.c"
            #include "vm_case_split.c"
            #include "vm_case_join.c"
            #include "vm_case_substr.c"
            #include "vm_case_find.c"
            #include "vm_case_contains.c"
            #include "vm_case_index_of.c"
            #include "vm_case_clear.c"
            #include "vm_case_enumerate.c"
            #include "vm_case_zip.c"
            #include "vm_case_min.c"
            #include "vm_case_max.c"
            #include "vm_case_clamp.c"
            #include "vm_case_abs.c"
            #include "vm_case_pow.c"
            #include "vm_case_random_seed.c"
            #include "vm_case_random_int.c"
            #include "vm_case_make_map.c"
            #include "vm_case_keys.c"
            #include "vm_case_values.c"
            #include "vm_case_has_key.c"
            #include "vm_case_read_file.c"
            #include "vm_case_write_file.c"
            #include "vm_case_load_global.c"
            #include "vm_case_store_global.c"
            #include "vm_case_mod.c"
            #include "vm_case_and.c"
            #include "vm_case_or.c"
